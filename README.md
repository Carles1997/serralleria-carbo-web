...
## Consultar el mockup de la homepage

Obre `FASE4-mockups/home/index.html` directament al navegador. La maqueta actual i les seves notes de revisió són a [`FASE4-mockups/home/`](FASE4-mockups/home/). La pila prevista per al desenvolupament posterior és **Astro + Tailwind CSS** segons `CONTEXT-serralleria-carbo.md`.
